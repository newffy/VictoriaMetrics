...
func TestRowsUnmarshalFailure(t *testing.T) {
	...
	// Invalid value
	f(`{"metric": "aaa", "timestamp": 1122, "value": "trtr"}`)
	...
	//f(`{"metric": "aaa", "timestamp": 1122, "value": 0.45, "tags": {"rrr": false}}`)
	//f(`{"metric": "aaa", "timestamp": 1122, "value": 0.45, "tags": {"rrr": "ttt", "ssss": false}}`)
}
...
func TestRowsUnmarshalSuccess(t *testing.T) {
	...
	// Empty tag value
	f(`{"metric": "foobar", "timestamp": 789, "value": -123.456, "tags": {"a":"", "b":"c"}}`, &Rows{
		Rows: []Row{{
			Metric:    "foobar",
			Value:     -123.456,
			Timestamp: 789000,
	...
	f(`{"metric": "foo.bar", "timestamp": 789, "value": 123.456, "tags": {"a":"b"}}`, &Rows{
		Rows: []Row{{
			Metric:    "foo.bar",
			Value:     123.456,
			Timestamp: 789000,
